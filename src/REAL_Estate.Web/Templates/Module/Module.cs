...
namespace REAL_Estate.Web.Templates;
...
public class Module : GennyModule
{
    ...
    public override void Run()
    {
        ...
        {
            { $"../REAL_Estate.Services/{shortPath}{Model}Service.cs", Scaffold("Services/Service") },
            { $"../REAL_Estate.Validators/{shortPath}{Model}Validator.cs", Scaffold("Validators/Validator") },
            { $"../REAL_Estate.Controllers/{shortPath}{Controller}.cs", Scaffold("Controllers/Controller") },
            { $"../../test/REAL_Estate.Tests/Integration/Controllers/{shortPath}{Controller}Tests.cs", Scaffold("Tests/ControllerTests") },

            { $"../REAL_Estate.Web/Views/{path}/Index.cshtml", Scaffold("Web/Index") },
            { $"../REAL_Estate.Web/Views/{path}/Create.cshtml", Scaffold("Web/Create") },
            { $"../REAL_Estate.Web/Views/{path}/Details.cshtml", Scaffold("Web/Details") },
            { $"../REAL_Estate.Web/Views/{path}/Edit.cshtml", Scaffold("Web/Edit") },
            { $"../REAL_Estate.Web/Views/{path}/Delete.cshtml", Scaffold("Web/Delete") }
        };

        foreach (String view in model.ViewProperties.Keys.Where(key => key.Length == 0 || model.Views[key] != model.Views[""]))
            results[$"../REAL_Estate.Web/Resources/Views/{path}/{Model}{view}View.json"] = Scaffold($"Resources/{view}View");

        foreach (Type type in model.EnumTypes)
            results[$"../REAL_Estate.Web/Resources/Enums/{path}/{type.Name}.json"] = Scaffold("Resources/Enum", Enum.GetNames(type));

        if (!File.Exists($"../REAL_Estate.Objects/Models/{path}/{Model}.cs") ||
            !File.Exists($"../REAL_Estate.Objects/Views/{path}/{Model}View.cs"))
            results = new Dictionary<String, GennyScaffoldingResult>
            {
                { $"../REAL_Estate.Objects/Models/{path}/{Model}.cs", Scaffold("Objects/Model") },
                { $"../REAL_Estate.Objects/Views/{path}/{Model}View.cs", Scaffold("Objects/View") }
            };
    ...
    private void AddArea()
    {
        ...
        Logger.Write("../REAL_Estate.Controllers/Area.cs - ");

        String content = File.ReadAllText("../REAL_Estate.Controllers/Area.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../REAL_Estate.Controllers/Area.cs", content);
    ...
    {
        Logger.Write("../REAL_Estate.Web/mvc.sitemap - ");
    ...
    {
        Logger.Write("../REAL_Estate.Data/Migrations/Configuration.cs - ");

        String content = File.ReadAllText("../REAL_Estate.Data/Migrations/Configuration.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../REAL_Estate.Data/Migrations/Configuration.cs", content);
    ...
    {
        Logger.Write("../REAL_Estate.Web/Views/_ViewImports.cshtml - ");

        String content = File.ReadAllText("../REAL_Estate.Web/Views/_ViewImports.cshtml");
        String[] imports = Regex.Matches(content, "@using (.+);").Select(match => match.Value).ToArray();
        String[] newImports = imports
            .Append(Area == null ? "@using REAL_Estate.Controllers;" : $"@using REAL_Estate.Controllers.{Area};")
            .Distinct()
        ...
        else
        {
            ...
            File.WriteAllText("../REAL_Estate.Web/Views/_ViewImports.cshtml", content);
    ...
    {
        Logger.Write("../../test/REAL_Estate.Tests/Helpers/ObjectsFactory.cs - ");

        String content = File.ReadAllText("../../test/REAL_Estate.Tests/Helpers/ObjectsFactory.cs");
        ModuleModel model = new(Model!, Controller!, Area);
        ...
        else
        {
            ...
            File.WriteAllText("../../test/REAL_Estate.Tests/Helpers/ObjectsFactory.cs", newContent);
    ...
    {
        Logger.Write("../../test/REAL_Estate.Tests/Unit/Data/Migrations/ConfigurationTests.cs - ");

        String content = File.ReadAllText("../../test/REAL_Estate.Tests/Unit/Data/Migrations/ConfigurationTests.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/REAL_Estate.Tests/Unit/Data/Migrations/ConfigurationTests.cs", content);
    ...
    {
        Logger.Write("../../test/REAL_Estate.Tests/Helpers/TestingContext.cs - ");

        String content = File.ReadAllText("../../test/REAL_Estate.Tests/Helpers/TestingContext.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/REAL_Estate.Tests/Helpers/TestingContext.cs", content);
    ...
    {
        Logger.Write($"../REAL_Estate.Web/Resources/Shared/{resource}.json - ");
