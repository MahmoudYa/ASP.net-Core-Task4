...
using REAL_Estate.Components.Logging;
using REAL_Estate.Components.Mail;
using REAL_Estate.Components.Mvc;
using REAL_Estate.Components.Security;
using REAL_Estate.Controllers;
using REAL_Estate.Data;
using REAL_Estate.Data.Migrations;
...
public class Startup
{
    ...
    public Startup(IHostEnvironment host)
    {
        ...
        Config = new ConfigurationBuilder()
            ...
            .AddEnvironmentVariables($"REAL_Estate__{host.EnvironmentName}__")
            .Build();
    }
